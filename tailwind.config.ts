...
export default {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        "display-lg": ["56px", { lineHeight: "1.0", letterSpacing: "-0.04em", fontWeight: "800" }],
        "display": ["46px", { lineHeight: "1.05", letterSpacing: "-0.03em", fontWeight: "800" }],
        "heading": ["32px", { lineHeight: "1.15", letterSpacing: "-0.03em", fontWeight: "700" }],
        "subheading": ["22px", { lineHeight: "1.25", letterSpacing: "-0.02em", fontWeight: "600" }],
        "body": ["15px", { lineHeight: "1.7", letterSpacing: "0", fontWeight: "500" }],
        "small": ["13px", { lineHeight: "1.6", letterSpacing: "0", fontWeight: "500" }],
